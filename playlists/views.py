...
class PlaylistViewSet(CoreViewSet):  
    queryset = Playlist.objects.all()  
    serializer_class = PlaylistSerializer
    
class AdminPlaylistViewSet(AdminCoreViewSet, PlaylistViewSet):  
    pass


    
class DashboardPlaylistViewSet(DashboardCoreViewSet, PlaylistViewSet):
    pass
