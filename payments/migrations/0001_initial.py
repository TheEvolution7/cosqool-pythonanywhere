    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(max_length=3)),
                ('charged_value', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=12)),
                ('authorized_value', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=12)),
                ('refunded_value', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=12)),
                ('voided_value', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=12)),
